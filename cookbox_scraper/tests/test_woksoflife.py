...
class TestWoksOfLifeOldScraper(RecipeScraperTestMixin, TestCase):
    ...
    def setUp(self):
        ...
        self.ingredients = [('All', [('8', 'ounces', 'flank steak, (225g, sliced against the grain into 1/4-inch thick slices)'), ('1', 'teaspoon', 'oil'), ('1', 'teaspoon', 'low sodium soy sauce'), ('1', 'tablespoon', 'cornstarch, (plus 1/4 cup, divided)'), ('1/3', 'cup', 'vegetable oil, (for frying the beef)'), ('1/2', 'teaspoon', 'ginger, (minced)'), ('5', None, 'dried red chili peppers, (optional)'), ('2', 'cloves', 'garlic, (chopped)'), ('1/4', 'cup', 'low sodium soy sauce'), ('1/4', 'cup', 'water, (or low sodium chicken stock)'), ('2', 'tablespoons', 'brown sugar'), ('1', 'tablespoon', 'cornstarch, (mixed with 1 tablespoon water)'), ('2', None, 'scallions, (cut into 1-inch long slices on the diagonal)')])]
