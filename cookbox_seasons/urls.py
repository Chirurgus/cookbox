...
urlpatterns = [
    ...
    path('item/<slug:pk>/edit/', SeasonsItemEditView.as_view(), name="seasons-item-edit"),
    path('item/<slug:pk>/delete/', SeasonsItemDeleteView.as_view(), name="seasons-item-delete"),
]