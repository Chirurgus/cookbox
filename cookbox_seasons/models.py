...
class SeasonsItem(models.Model):
    PEAK_SEASON = "peak"
    IN_SEASON = "in"
    OUT_OF_SEASON = "out"
    ...
    jan = models.CharField(
        max_length=CHAR_FIELD_MAX_LEN_SHORT, choices=SEASON_STATE, default=OUT_OF_SEASON
    )
    feb = models.CharField(
        max_length=CHAR_FIELD_MAX_LEN_SHORT, choices=SEASON_STATE, default=OUT_OF_SEASON
    )
    mar = models.CharField(
        max_length=CHAR_FIELD_MAX_LEN_SHORT, choices=SEASON_STATE, default=OUT_OF_SEASON
    )
    apr = models.CharField(
        max_length=CHAR_FIELD_MAX_LEN_SHORT, choices=SEASON_STATE, default=OUT_OF_SEASON
    )
    may = models.CharField(
        max_length=CHAR_FIELD_MAX_LEN_SHORT, choices=SEASON_STATE, default=OUT_OF_SEASON
    )
    jun = models.CharField(
        max_length=CHAR_FIELD_MAX_LEN_SHORT, choices=SEASON_STATE, default=OUT_OF_SEASON
    )
    jul = models.CharField(
        max_length=CHAR_FIELD_MAX_LEN_SHORT, choices=SEASON_STATE, default=OUT_OF_SEASON
    )
    aug = models.CharField(
        max_length=CHAR_FIELD_MAX_LEN_SHORT, choices=SEASON_STATE, default=OUT_OF_SEASON
    )
