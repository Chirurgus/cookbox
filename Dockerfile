...
CMD chown -R www-data:www-data /opt/cookbox/data /opt/cookbox/logs && \
	chmod -R u+rw /opt/cookbox/data /opt/cookbox/logs && \
	chmod -R a+r /opt/cookbox/data /opt/cookbox/logs && \
